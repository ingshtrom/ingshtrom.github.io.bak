+(function(window, angular, undefined){
  ...
  var mfb = angular.module('ng-mfb', ['ngMaterial']);
  ...
  mfb.directive('mfbMenu', ['$timeout',function($timeout){
    return {
      ...
      template: '<ul class="mfb-component--{{position}} mfb-{{effect}}" data-mfb-toggle="{{togglingMethod}}" data-mfb-state="{{currentState}}">' +
                ...
                '  <md-button ng-click="toggleMenu()" data-mfb-label="{{label}}" class="md-fab md-default-theme mfb-component__button--main">' +
  ...
  mfb.directive('mfbButton', [function(){
    return {
      ...
      template: '<li>' + 
                ' <md-button href="" data-mfb-label="{{label}}" class="md-fab md-default-theme mfb-component__button--child">' +
                '   <md-icon md-font-icon="{{icon}}">' +
                '   </md-icon>' +
                ' </md-button>' +
                '</li>'
    };
